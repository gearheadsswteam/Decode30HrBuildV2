...
import org.firstinspires.ftc.teamcode.fsm.movement.Twist;
...
public class Otos extends I2cDeviceSynchDevice<I2cDeviceSynch> {
    ...
    public Otos(I2cDeviceSynch deviceClient)
    {
     ...
     */
    public void getVersionInfo(com.qualcomm.hardware.sparkfun.SparkFunOTOS.Version hwVersion, com.qualcomm.hardware.sparkfun.SparkFunOTOS.Version fwVersion) {
    ...
    public boolean selfTest() {
        ...
        com.qualcomm.hardware.sparkfun.SparkFunOTOS.SelfTestConfig selfTest = new com.qualcomm.hardware.sparkfun.SparkFunOTOS.SelfTestConfig();
        selfTest.set((byte) 1);
    ...
    public com.qualcomm.hardware.sparkfun.SparkFunOTOS.SignalProcessConfig getSignalProcessConfig() {
        ...
        return new com.qualcomm.hardware.sparkfun.SparkFunOTOS.SignalProcessConfig(deviceClient.read8(REG_SIGNAL_PROCESS));
    }
     ...
     */
    public void setSignalProcessConfig(com.qualcomm.hardware.sparkfun.SparkFunOTOS.SignalProcessConfig config) {
    ...
    public com.qualcomm.hardware.sparkfun.SparkFunOTOS.Status getStatus() {
        return new com.qualcomm.hardware.sparkfun.SparkFunOTOS.Status(deviceClient.read8(REG_STATUS));
    }
     ...
     */
    public Pose getAccelerationStdDev() {
    ...
    protected Pose readPoseRegs(byte reg, double rawToXY, double rawToH) {
    ...
    protected void writePoseRegs(byte reg, Pose pose, double xyToRaw, double hToRaw) {
    ...
    protected Pose regsToPose(byte[] rawData, double rawToXY, double rawToH) {
    ...
    protected void poseToRegs(byte[] rawData, Pose pose, double xyToRaw, double hToRaw) {
